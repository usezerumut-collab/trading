...
# BURASI ÇOK ÖNEMLİ: Google Sheets linkini tırnak içine yapıştır kanka
SHEET_URL = "BURAYA_GOOGLE_SHEETS_LINKINI_YAPISTIR"
...
if not st.session_state.auth:
    ...
    with cent:
        ...
        u_id = st.text_input("ID", placeholder="İsminizi yazın...", key="login_id")
